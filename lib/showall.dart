...
class _MyHomePageState extends State<MyHomePage1> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('All rated'),
      centerTitle: true,),
      body: SafeArea(
          child: SingleChildScrollView(
            child: Column(children: [
             ...
             FutureBuilder(future: viewsurveyall(),
  ...
  Future<void> _sendEmail(String email,String TXT,String MR) async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('Sending failed  call Eng Romany  \n$e')));
    }
  }
